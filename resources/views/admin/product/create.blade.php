       ...
       <!-- page content -->
            ...
            {!! Form::open(array('route' => 'ob-admin.products.store', 'data-parsely-validate' => '', 'files' => true)) !!}
            <div class="row">
             <div class="col-md-9 col-sm-9 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  {{ Form::text('productname', null, array('class' => 'form-control title', 'id' => 'productTitle', 'required' => '', 'maxlength' => '255')) }}
                  <div class="divider-dashed"></div>

                  {{ Form::label('slug', 'Slug *') }}
                  {{ Form::text('slug', null, array('class' => 'form-control slug', 'id' => 'productSlug', 'required' => '', 'maxlength' => '255')) }}
                  <div class="divider-dashed"></div>
                ...
                <div class="col-md-3 col-sm-3 col-xs-12">
                    <div class="x_panel">
                      {{ Html::linkRoute('ob-admin.products.index' ,'View all products', array(), ['class' => 'btn btn-success btn-block'])}}
                    </div>
                </div>
        ...
        <!-- /page content -->
          ...
          $('#productSlug').click(function(){
            $("#productSlug").attr("readonly", false); 
           });
          </script>
